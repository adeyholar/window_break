#!/usr/bin/env python3
"""
Unified Break Reminder Application with Windows Auto-Start
Complete solution with activity detection, system tray, and Windows integration
"""
...
class WindowsAutoStart:
    """Handles Windows startup integration"""
